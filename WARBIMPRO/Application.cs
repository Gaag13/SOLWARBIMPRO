    ...
    public class Application : ExternalApplication
    {
        ...
        private void CreateRibbon()
        {
            ...
            panelLogin.AddPushButton<CmdKeyFireSharp>("Iniciar\nSesion")
                ...
                .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=sS_Ygv22080&list=PLH3SaHo_303s&index=2"));
            ...
            panelFamilys.AddPushButton<CmdLoadFamilys>("Importar\nFamilia")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=3"));
            ...
            panelFamilys.AddPushButton<CmdFamilyBrowser>("Explorador de\nFamilias")
              ...
              .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=cyeyghn9A-M&list=PLH3SaHo_303s&index=4"));
            ...
            panelFamilys.AddPushButton<CmdExportFamilies>("Exportar\nFamilias")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=5"));
            ...
            panelFamilys.AddPushButton<CmdGrids3D>("Rejillas 3D\n2D")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=6"));
            ...
            panelFamilys.AddPushButton<CmdBimFamilyCreator>("Creador de\nFamilias")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=7"));
            ...
            panelViews.AddPushButton<CmdFindReplaceView>("Buscar en\nVistas")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=8"));
            ...
            panelViews.AddPushButton<CmdDuplicateElement>("Duplicar\nElemento EST")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=9"));
            ...
            panelViews.AddPushButton<CmdTranferViewTemplate>("Transferir\nPlantilla")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=10"));
            ...
            panelViews.AddPushButton<CmdFiltroElementos>("Filtrar\nElementos")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=11"));
            ...
            panelRefuerzo.AddPushButton<CmdShowRebar3D>("Ver Rebar\n3D")
               ...
               .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=12"));
            ...
            panelCantidades.AddPushButton<CmdCantidades>("Cuantificación")
                ...
                .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=13"));
            ...
            paneltopografia.AddPushButton<CmdTestDelaunay>("Toposolid")
                ...
                .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=14"));
            ...
            paneltopografia.AddPushButton<CmdCreateRoad>("Crear\n Carretera")
                ...
                .SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://www.youtube.com/watch?v=--YslshGHms&list=PLH3SaHo_303s&index=15"));
#endif
